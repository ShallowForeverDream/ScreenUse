...
export const fallbackDashboard: DashboardData = {
  ...
  sessions: [
    ...
    { id: 's4', startedAt: iso(32), endedAt: iso(8), projectId: null, projectName: null, taskId: null, taskTitle: null, category: '杂务', summary: 'Chrome · 新标签页', confidence: 0.56, userConfirmed: false, source: 'collector-rule', evidence: [{ kind: 'window', label: '窗口', value: '新标签页', weight: 0.5 }] },
  ],
  planItems: [
